...
var $ChangeCompanyLogoInput = $("#ChangeCompanyLogoInput");
$("#ChangeCompanyLogo").click(function (e) {
    e.preventDefault();
    $ChangeCompanyLogoInput.trigger('click');
    //$ChangeCompanyLogoInput.parent("figure.card-profile-image").find("img#avatar").attr("src", $ChangeTemporaryCompanyLogoFile.val());
});

$ChangeCompanyLogoInput.change(function () {
    $(this).parent("form").submit();
});

function changeAvatarCallback(p_json){
    var json=$.parseJSON(p_json);
    
    if(json.success==true)
    {
        $("#avatar").attr("src",json.filename);
        Materialize.toast(json.msg, 10000);
    }
